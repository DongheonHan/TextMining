...
% 2017-2018
str49 = extractFileText("2017년도 고부가가치식품기술개발사업 자유응모과제 시행계획(2차) 공고.pdf");
str50 = extractFileText("2017년도 고부가가치식품기술개발사업 지정공모과제 시행계획 공고.pdf");
str51 = extractFileText("2017년도 고부가가치식품기술개발사업 지정공모과제 시행계획(2차) 공고.pdf");
str52 = extractFileText("2017년도 농림축산식품 수출전략기술개발사업(수출연구사업단) 시행계획 공고1.pdf");
str53 = extractFileText("2017년도 수출전략기술개발사업(수출연구사업단 총괄사업단) 시행계획 공고 (1).pdf");
str54 = extractFileText("2018년도 고부가가치식품기술개발사업 자유응모과제(사전기획형) 시행계획 공고.pdf");
str55 = extractFileText("2018년도 고부가가치식품기술개발사업 자유응모과제(스타트업 지원) 시행계획 공고.pdf");
str56 = extractFileText("2018년도 고부가가치식품기술개발사업 지정공모과제 시행계획 공고.pdf");
str57 = extractFileText("2018년도 하반기 고부가가치식품기술개발사업 지정공모과제 시행계획 공고.pdf");
str58 = extractFileText("170925_2. 2017년도 가축질병대응기술개발사업 지정공모과제(백신접종 보정틀) 시행계획 추가 공고.pdf");
str59 = extractFileText("180907_2018년도 가축질병대응기술개발사업 자유응모과제 시행계획 공고(최종).pdf");
str60 = extractFileText("180907_2018년도 농생명산업기술개발사업 지정공모과제 시행계획 공고(최종).pdf");
str61 = extractFileText("181112_1. 2018년도 하반기 첨단생산기술개발사업 시행계획 추가 공고(최종)v2.pdf");
...
textData = str1 + str2 + str3 + str4 + str5 + str6 + str7 + str8 + str9 + ...
    ...
    str44 + str45 + str46 + str47 + str48 + str49 + str50 + str51 + str52 +...
    str53 + str54 + str55 + str56 + str57 + str58 + str59 + str60 + str61;
...
title("Word cloud chart [2017-2021]")